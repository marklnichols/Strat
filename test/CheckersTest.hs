...
checkersTest =  
    describe "getPossibleMoves" $
        it "Gets the list of possible moves for a given color from a given position." $ do
            ...
            getPossibleMoves (nodeFromGridW board02) `shouldMatchList` [510, 711, 813, 2529, 2823, 2824, 3329, 3338, 3934, 3935,
                                                                        10717, 11624, 11626, 12515, 12517, 12535]
            getPossibleMoves (nodeFromGridB board02) `shouldMatchList` [2015, 2024, 2117, 3026, 12111, 13729]
